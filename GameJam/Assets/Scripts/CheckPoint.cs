...
public class CheckPoint : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if(other.gameObject.CompareTag("Player"))
        {
            ...
            {
                other.gameObject.GetComponent<Player>().CheckpointRestoreHP(1);
            ...
            /*if(/*other.gameObject.GetComponent<ChangeGravityTest>().enabled == true && #1#
                other.gameObject.GetComponent<ChangeGravityTest>().CurrentCheckPoint != transform.position)
            {
